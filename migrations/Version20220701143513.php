 ...
 */
final class Version20220701143513 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category CHANGE color color VARCHAR(10) NOT NULL');
        $this->addSql('ALTER TABLE comment DROP FOREIGN KEY FK_9474526C727ACA70');
        $this->addSql('DROP INDEX IDX_9474526CA76ED395 ON comment');
        $this->addSql('DROP INDEX IDX_9474526C727ACA70 ON comment');
        $this->addSql('ALTER TABLE comment DROP user_id, DROP parent_id, CHANGE content content VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article CHANGE featured_text featured_text LONGTEXT DEFAULT NULL');
        $this->addSql('ALTER TABLE category CHANGE color color VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE comment ADD user_id INT NOT NULL, ADD parent_id INT DEFAULT NULL, CHANGE content content LONGTEXT NOT NULL');
